...
Here as well as in the modelling code, all coordinates are in EPSG:28992 Projected coordinate system for Netherlands. 
...
```{r}
NL <- st_read("data_paper/NL.shp")$geometry
