...
# Combine plots
plot.all <- ggdraw() +
  draw_plot(plot.validation.1, x = 0, y = 0, width = 0.50, height = 1) +
  draw_plot(plot.validation.2, x = 0.49, y = 0, width = 0.55, height = 1) +
  draw_plot_label(label = c("A", "B"), size = 15, x = c(0.01, 0.50), y = c(0.99,0.99)) +
  theme(plot.background = element_rect(fill = "white", colour = NA))
plot.all
ggsave('results_paper/leave_out_validation.png', width=4600, heigh=1800, units='px')
